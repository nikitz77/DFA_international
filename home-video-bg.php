...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- Page Title -->
    <title>HISHAM - Non Profit Charity responsive HTML template.</title>
    <!-- Favicon Icon -->
	...
	<section class="hero text-center" id="home">
		<div class="single-slide youtube-bg">
			...
			<div class="container">
				...
				<h3>AWESOME THEMEZ PRESENT NON-PROFIT WEBSITE</h3>
				<h5>Donation and help us for homeless people.We are a organization that helps for children and homeless poor people</h5>
    ...
    <section class="about section" id="about">
        <div class="container">
            <div class="section-header">
                <h2>About Us</h2>
                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quaes inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem.</p>
            </div><!-- .section-header -->
            <div class="row">
                <div class="col-lg-6">
